...
describe('express-request-ajax-error', function() {
  ...
  it('checks the impossible', function(done) {
    return superagent.get('http://localhost:1234/impossible').end(function(err, res){
  ...
  it('should throw an error', function(done) {
    return superagent.get('http://localhost:1234/error').end(function(err, res){
  ...
  it('should throw an error from api', function(done) {
    return superagent.get('http://localhost:1234/api_error').end(function(err, res){
  ...
  it('should call logout callback', function(done) {
    return superagent.get('http://localhost:1234/unauthorized_logout').end(function(err, res){
  ...
  it('should not call logout callback', function(done) {
    return superagent.get('http://localhost:1234/api_error_dont_logout').end(function(err, res){
  ...
  it('should not show 403', function(done) {
    return superagent.get('http://localhost:1234/unauthorized').end(function(err, res){
  ...
  it('should not throw an error', function(done) {
    return superagent.get('http://localhost:1234/data').end(function(err, res){
  ...
  it('should only redirect once', function(done) {
    return superagent.get('http://localhost:1234/concurrent').end(function(err, res){
      expect(res.text).to.equal('home');
      done();
    });
  });
  ...
  describe('Backbone.ajax', function() {
    ...
    it('should throw an error', function(done) {
      return superagent.get('http://localhost:1234/backbone/auth_error').end(function(err, res){
        expect(res.text).to.equal('no auth mechanism definedundefined500');
        done();
      });
    });
    ...
    it('should throw an api_error', function(done) {
      return superagent.get('http://localhost:1234/backbone/api_error').end(function(err, res){
    ...
    it('should redirect to home', function(done) {
      return superagent.get('http://localhost:1234/backbone/unauthorized_logout').end(function(err, res){
